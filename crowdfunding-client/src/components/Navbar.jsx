    ...
    <nav className="w-full bg-[#14171F]/95 backdrop-blur border-b border-white/5 sticky top-0 z-50">
      ...
      {menuOpen && (
        ...
        >
          {!isPending && !user && (
            <>
              <Link href="/campaigns" className="text-[#F3EFE4] text-sm" onClick={() => setMenuOpen(false)}>
                Explore Campaigns
              </Link>
              <Link href="/login" className="text-[#F3EFE4] text-sm" onClick={() => setMenuOpen(false)}>
                Login
              </Link>
              <Link
                href="/register"
            ...
            <>
              <div className="flex items-center gap-3 pb-3 border-b border-white/5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[#9AA1AE] text-xs truncate">{user.email}</p>
                </div>
              </div>
              ...
              <Link href="/dashboard" className="text-[#F3EFE4] text-sm" onClick={() => setMenuOpen(false)}>
                Dashboard
              </Link>
              <a
                href={GITHUB_CLIENT_REPO}
